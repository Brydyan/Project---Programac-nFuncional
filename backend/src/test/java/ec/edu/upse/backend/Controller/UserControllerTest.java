...
class UserControllerTest {
    ...
    void uploadPhoto_multipart_debeRetornar200() throws Exception {
        ...
        when(firebaseStorageService.uploadUserAvatar(eq("6"), any())).thenReturn(java.util.Map.of("photoUrl",
                "https://storage.googleapis.com/bucket/users/6/avatar.jpg", "photoPath", "users/6/avatar.jpg"));
        ...
        org.springframework.mock.web.MockMultipartFile file = new org.springframework.mock.web.MockMultipartFile("file",
                "avatar.jpg", "image/jpeg", "data".getBytes());
